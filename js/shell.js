...
(function () {
 ...
 var ICONS = {
    ...
    template: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9"/></svg>',
    ...
    chart: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4v16h16"/><path d="M8 16v-4M13 16V8M18 16v-6"/></svg>',
 ...
 var NAV = [
    ...
    { id: 'projects', href: 'projects.html', icon: 'folder', label: 'Loyihalarim' },
    { id: 'create', href: 'create.html', icon: 'wand', label: 'AR Yaratish' },
    { id: 'templates', href: 'templates.html', icon: 'template', label: 'Shablonlar' },
    { id: 'models', href: 'models.html', icon: 'cube', label: 'Modellarim' },
    { section: "Ko'rish" },
    ...
    { section: 'Boshqaruv' },
    { id: 'analytics', href: 'analytics.html', icon: 'chart', label: 'Analitika' },
    { id: 'pricing', href: 'pricing.html', icon: 'tag', label: 'Tariflar' },
    { id: 'tutorials', href: 'tutorials.html', icon: 'book', label: 'Darslar' },
 ...
 var navHtml = NAV.map(function (item) {
    ...
    return (
       '<a class="nav-item' + active + '" href="' + item.href + '">' + ICONS[item.icon] + item.label + '</a>'
       );
 }).join('');
